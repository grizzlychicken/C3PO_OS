...
namespace MyActuator {
    namespace TestSupport {
        ...
        class CircularBuffer {
            ...
            /**
             * Adds an array of elements to the end of buffer: the operation returns `false` if the addition caused overwriting existing elements.
             */
            bool push(T * buf, size_t len);
        ...
        template <typename T, size_t S, typename IT>
        bool CircularBuffer<T, S, IT>::push(T * value, size_t count)
        {
            bool result = true;
